        ...
        {step === 3 ? (
          ...
          <div className="modal-body p-6 animate-fade-in is-revealed reveal-active font-tech" style={{ maxWidth: '780px', margin: '0 auto', width: '100%' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center bg-zinc-950 border border-zinc-800 p-4 sm:p-6 rounded-2xl shadow-2xl">
              ...
              {/* Left Column: Official UPI QR Code ONLY (Smaller by 60% in mobile and bounded within 2 screen edges) */}
              <div className="md:col-span-4 flex flex-col items-center justify-center p-2 sm:p-4 bg-zinc-900/60 border border-zinc-800 rounded-xl h-full w-full mx-auto max-w-[125px] sm:max-w-[170px] md:max-w-none overflow-hidden">
                <div className="bg-white rounded-lg shadow-2xl border border-zinc-200 p-1 flex items-center justify-center w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto overflow-hidden shrink-0" style={{ width: '56px', height: '56px', maxWidth: '100%', maxHeight: '100%' }}>
                  <img 
                    src="/guildqr.png" 
                ...
                <span className="text-[8px] sm:text-xs text-gray-400 font-bold mt-1 sm:mt-3 tracking-wider uppercase block truncate w-full">// OFFICIAL SCANNER QR</span>
              </div>
